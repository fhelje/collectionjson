...
{
    public class CollectionJsonDocumentBuilder : CollectionJson.Infrastructure.ICollectionJsonDocumentBuilder
    {
        public Document Build(IEnumerable<Friend> friends)
        {
